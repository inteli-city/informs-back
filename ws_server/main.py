...
NÃO temos endpoint REST de histórico aqui — esse vive no serverless
(Lambda + API Gateway, GET /mss-formularios/tracking/history). Razões:
- Reusa Cognito Authorizer e padrão clean architecture do projeto.
- Mantém ws_server focado em real-time.
- Auto-scale + zero manutenção.
"""
