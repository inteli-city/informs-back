...
from src.shared.helpers.contracts.endpoints.update_template_contract import UpdateTemplateResponseSchema
...
class TemplateViewmodel:
    ...
    def to_dict(self):
        ...
        return UpdateTemplateResponseSchema.model_validate(payload).model_dump()
